use crate::text::{ FontState, word_to_char_code };
...
impl DataView {
	...
	pub fn get_encoded_string(&self, font_state: &FontState, i: usize, len: usize) -> String {
...
// #[tauri::command]
// pub fn encode_string_old(string: &str) -> Vec<u16> {
// 	let mut data: Vec<u16> = Vec::new();

// 	let quote_regex = Regex::new(r#""([^"]*)""#).unwrap();
// 	let string = quote_regex.replace_all(string, "「$1」");
...
// 			'}' | '>' => {
// 				var_name.push(ch);
// 				if let Some(word) = get_char_encoding(&var_name.to_lowercase()) {
// 					data.push(word);
// 				}
// 				var_name = String::new();
// 			},
